...
1. Download [`OneSkyScreenshotHelper-v0.5.2.jar`](https://github.com/onesky/auto-screenshot-android/releases/download/0.5.1/OneSkyScreenshotHelper-v0.5.2.jar) in the release tab in this GitHub page and drag it into the ```libs``` folder of your project.
