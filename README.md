...
```java
	dependencies {
		// other dependencies.
	    compile "com.oneskyapp:screenshot:0.7.5"
	}
```
...
1. Download [`OneSkyScreenshotHelper-v0.7.5.jar`](https://github.com/onesky/auto-screenshot-android/releases/download/v0.7.5/OneSkyScreenshotHelper-v0.7.5.jar) in the release tab in this GitHub page and drag it into the ```libs``` folder of your project.
...
```java
	dependencies {
		compile files("OneSkyScreenshotHelper-v0.7.5.jar")
	}
```
